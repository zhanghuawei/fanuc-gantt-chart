<template>
  <div class="q-pa-sm">
    <gantt-elastic ref="ganttElasticContainer" :options="options" :tasks="tasks" @tasks-changed="tasksUpdate" @options-changed="optionsUpdate"
      @dynamic-style-changed="styleUpdate">
      <gantt-header slot="header"></gantt-header>
    </gantt-elastic>
    <div class="q-mt-md" />
    <button @click="addTask" icon="mdi-plus" label="Add task" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    initGantt() {
      const container = this.$refs.ganttElasticContainer;
      this.gantt = new GanttElastic(container);
